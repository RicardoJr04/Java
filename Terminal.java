...
public class Terminal {
    ...
    private Card cartao;
    private Category[] categoriasPremio;

    public Terminal(){
        cartao = null;
        categoriasPremio = new Category[3];
        categoriasPremio[0] = new Category("Categoria 1", 5, 10);
        categoriasPremio[1] = new Category("Categoria 2", 10, 5);
        categoriasPremio[2] = new Category("Categoria 3", 15, 3);
    
    }
    public void inserirCartao(Card cartao) {
        this.cartao = cartao;
...
public void transferSaldo(Card cartaoorigem, Card cartaodestino){
    ...
    public void trocarTicketsPorPremios(int categoria) {
        if (categoria >= 0 && categoria < categoriasPremio.length) {
            Category categoriaPremio = categoriasPremio[categoria];
